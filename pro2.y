...
%token <str> BODY_OPEN BODY_CLOSE P_CLOSE DIV_CLOSE H1_CLOSE
...
%token <str> TEXT
%token <str> INLINE_CSS_P INLINE_CSS_DIV INLINE_CSS_H1
...
element: title
       | INLINE_CSS_P TEXT P_CLOSE               { $$ = createNode("p"); addChild($$, createNode($2)); }
       | INLINE_CSS_DIV content DIV_CLOSE        { $$ = createNode("div"); addChild($$, $2); }
       | INLINE_CSS_H1 TEXT H1_CLOSE             { $$ = createNode("h1"); addChild($$, createNode($2)); }
